...
//     if(schoolName.isNotEmpty && schoolAddress1.isNotEmpty && city.isNotEmpty && state.isNotEmpty
//         && country.isNotEmpty && zipCode.isNotEmpty && adminFirstName.isNotEmpty
//         && adminLastName.isNotEmpty && adminEmail.isNotEmpty) {
//         var response = await http.post(
//         Uri.parse('http://10.252.1.117:3001/src/Services/admin/Request_Approval.js'),
//         body: json.encode({
